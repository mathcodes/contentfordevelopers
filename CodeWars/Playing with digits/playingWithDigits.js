...
// Given 
    ...
    // a positive integer n written as abcd... (a, b, c, d... being digits) and 
...
function digPow(n, p){
  // split n into separate integers and set to variables
  var digits = Array.from(n.toString()).map(Number);
  console.log(digits) //[ 4, 6, 5 ] 
  ...
  // check if equation = n*k and return either k or -1
}
