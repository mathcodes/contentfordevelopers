      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-2 sm:pt-1 lg:px-8 lg:pt-4">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            We aim to please users with not just another solution bank to LeetCode problems, but more.
            </p>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-500">&copy; 2026 ContentForDevelopers.com</p>
        </div>
      </div>
    </footer>
  )
