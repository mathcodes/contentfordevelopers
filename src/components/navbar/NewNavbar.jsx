...
const NewNavbar = () => {
  ...
  return (
    <header className="w-[100vw] bg-[#1976d2] text-white fixed z-50">
            ...
            <div className="absolute top-12 right-4 bg-white rounded-md divide-y-2 px-2">
              ...
              <div className="flex flex-col justify-center items-center gap-2">
                {settings.map((setting) => (
                  <a className="text-black w-full text-center px-4 py-1 first-of-type:mt-2 last-of-type:mb-2 hover:bg-gray-200 cursor-pointer">
                    {setting}
                  </a>
                ))}
              </div>
